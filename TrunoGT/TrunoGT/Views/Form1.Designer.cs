namespace TrunoGT
{
    ...
    "реполнения\nИсполнитель: Бочкарев Михаил\nГруппа: 6304";
			...
			this.label6.Location = new System.Drawing.Point(478, 115);
			...
			// fileBoxLog
			// 
			this.fileBoxLog.Location = new System.Drawing.Point(478, 131);
			this.fileBoxLog.Name = "fileBoxLog";
			this.fileBoxLog.Size = new System.Drawing.Size(316, 317);
    ...
    "больше одного раза\nИсполнитель: Грушин Анатолий\nГруппа: 6304";
			...
			// button11
			// 
			this.button11.Location = new System.Drawing.Point(500, 11);
